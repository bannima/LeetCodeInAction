...
| 7   |   树递归   |                          [剑指 Offer 07. 重建二叉树](https://leetcode.cn/problems/zhong-jian-er-cha-shu-lcof/)   [669. 修剪二叉搜索树](https://leetcode.cn/problems/trim-a-binary-search-tree/)                          | [树递归](https://leetcode.cn/problems/trim-a-binary-search-tree/solution/shu-di-gui-by-zhou-en-guo-xloz/)                  | [297. 二叉树的序列化与反序列化](https://leetcode.cn/problems/serialize-and-deserialize-binary-tree/) |
...
| 9   |   递归    |                                              [21. 合并两个有序链表](https://leetcode.cn/problems/merge-two-sorted-lists/)                                              |      [一看就会，一写就废？详解递归](https://leetcode.cn/problems/merge-two-sorted-lists/solution/yi-kan-jiu-hui-yi-xie-jiu-fei-xiang-jie-di-gui-by-/)       |                                                                                          |
| 10  |   回溯    |                                                 [22. 括号生成](https://leetcode.cn/problems/generate-parentheses/)                                                 |      [括号生成](https://leetcode.cn/problems/generate-parentheses/solution/gua-hao-sheng-cheng-by-leetcode-solution/)        |                                                                                          |
| 11  |   并查集   |                                                 [547. 省份数量](https://leetcode.cn/problems/number-of-provinces/)                                                 |      [Python/C++/Java 多图详解并查集](https://leetcode.cn/problems/number-of-provinces/solution/python-duo-tu-xiang-jie-bing-cha-ji-by-m-vjdr/)            |                                                                                          |
...
- 32 [10. 正则表达式匹配](https://leetcode.cn/problems/regular-expression-matching/) -[dp](https://github.com/bannima/LeetCodeInAction/blob/master/dynamic_program/q10_regular-expression-matching/dp.py) - * ref:[「手画图解」动态规划，需要仔细的分情况讨论](https://leetcode.cn/problems/regular-expression-matching/solution/shou-hui-tu-jie-wo-tai-nan-liao-by-hyj8/)
...
- 13 [q113路径总和II](https://leetcode-cn.com/problems/path-sum-ii/) -[递归法](https://github.com/bannima/LeetCodeInAction/blob/master/tree/q113_path_sum_ii/solution.py) -[巧妙递归，不用复制路径](https://github.com/bannima/LeetCodeInAction/blob/master/tree/q113_path_sum_ii/smart_way.py)
...
### [排序](https://github.com/bannima/LeetCodeInAction/tree/master/sort)

- 1 [969. 煎饼排序](https://leetcode-cn.com/problems/pancake-sorting/) -[bubble sort](https://github.com/bannima/LeetCodeInAction/blob/master/sort/q969_pancake-sorting/bubble_sort.py)
...
- 5 [q539最小时间差](https://leetcode-cn.com/problems/minimum-time-difference/) -[解法](https://github.com/bannima/LeetCodeInAction/blob/master/others/q539_minimum_time_difference/solution.py) -[桶排序](https://github.com/bannima/LeetCodeInAction/blob/master/others/q539_minimum_time_difference/bucket_sort.py)
